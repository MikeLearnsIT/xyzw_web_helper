      ...
      <div v-if="playerInfo" class="player-info-content">
        <div class="player-info-main">
          ...
          <div class="player-info-detail">
            ...
            <p>俱乐部: {{ playerInfo.legionName || '无' }} | 红淬: {{ playerInfo.redQuench || 0 }} | 四圣数: {{
              playerInfo.holyBeast
              || 0 }}</p>
          ...
          <div class="equipment-grid">
            <div class="equipment-item">
              ...
              <div class="equipment-slots">
                <div v-for="(item, idx) in Object.values(Object.values(heroModealTemp.equipment)[0]?.quenches || {})"
            ...
            <div class="equipment-item">
              ...
              <div class="equipment-slots">
                <div v-for="(item, idx) in Object.values(Object.values(heroModealTemp.equipment)[1]?.quenches || {})"
                  :key="idx" class="equipment-slot" :class="{ 'red-slot': item.colorId === 6 }"></div>
              </div>
            </div>
            <div class="equipment-item">
              ...
              <div class="equipment-slots">
                <div v-for="(item, idx) in Object.values(Object.values(heroModealTemp.equipment)[2]?.quenches || {})"
                  :key="idx" class="equipment-slot" :class="{ 'red-slot': item.colorId === 6 }"></div>
              </div>
            </div>
            <div class="equipment-item">
              ...
              <div class="equipment-slots">
                <div v-for="(item, idx) in Object.values(Object.values(heroModealTemp.equipment)[3]?.quenches || {})"
                  :key="idx" class="equipment-slot" :class="{ 'red-slot': item.colorId === 6 }"></div>
              </div>
            </div>
          </div>
